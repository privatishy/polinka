...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if first_voice.exists():
        ...
        await update.message.reply_text(
            ...
            "<i>Бот учится на твоих реакциях. Если ответ понравился - нажми зеленую кнопку, если нет - нажми красную. Так бот будет понимать, как ответить лучше в следующий раз <tg-emoji emoji-id='5435877112814773242'>❗️</tg-emoji> </i>",
